...
<body><nav class="navbar navbar-expand-lg navbar-light shadow-5-strong">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          <ul class="nav justify-content-center nav-tabs">
            <li class="nav-item">
              <a class="nav-link"  href="<c:url value="/admindashboard"/>"><h4>Home</h4></a>
            </li>
            <li class="nav-item">
                    <a class="nav-link" href="/users"><h4>Users</h4></a>
            </li>
            
            <li class="nav-item">
              <a class="nav-link" href="<c:url value="/alltickets"/>"><h4>Tickets</h4></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="<c:url value="/categories"/>"><h4>Categories</h4></a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="<c:url value="/report"/>"><h4>Report</h4></a>
            </li>
            </ul>
            </div>
