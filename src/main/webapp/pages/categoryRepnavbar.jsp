...
<body><nav class="navbar navbar-expand-lg navbar-light shadow-5-strong">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
          <ul class="nav justify-content-center nav-tabs">
            <li class="nav-item">
              <a class="nav-link"  href="<c:url value="/categoryRepdashboard"/>"><h4>Home</h4></a>
            </li>
            <li class="nav-item">
                    <a class="nav-link" href="/replistissues"><h4>New / Active issues</h4></a>
            </li>
            
<!--             <li class="nav-item"> -->
<%--               <a class="nav-link" href="<c:url value="/alltickets"/>">Tickets</a> --%>
<!--             </li> -->
            </ul>
            </div>
